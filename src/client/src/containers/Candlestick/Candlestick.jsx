...
class Candlestick extends Component {
  ...
  constructor(props) {
    ...
    this.handleLatestCandlesticksClick =
      this.handleLatestCandlesticksClick.bind(this);
  }
  ...
  updateData(data) {
    ...
    const displayDataNewCandlestick = dataUtils.createCandlestickDisplay(
      data.newCandlestick
    );
    ...
    const displayIntervalsOptions = dataUtils.createIntervalOptions(
      data.intervalStartCreateTimestamp
    );
  ...
  render() {
    ...
    return (
      <div className='container'>
        <div
          className={`label ${connectionStatus ? 'connected' : 'disconnected'}`}
        >
            ...
            <div className={`control-panel${!displayLatest ? ' single' : ''}`}>
              {displayLatest && (
                <div className='row margin'>
                  <Button
                    onClick={this.handleLatestCandlesticksClick}
                    text='Get latest 20 candlesticks'
                  />
                </div>
              )}
              <div className='row'>
                <Select
                  ...
                  onChange={this.handleChangeIntervalTime}
